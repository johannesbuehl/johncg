<script setup lang="ts">
	...
	import type { ClientBibleSlides } from "@server/PlaylistItems/Bible";
	...
	<div class="slide_part">
		...
		<div class="slides_wrapper">
			<ItemSlideWrapper
				...
				@click="emit('select_slide', 0)"
			>
				<LowerThirds :text="slides.template.data.text" :icon="faBible" :visible="true" />
			</ItemSlideWrapper>
		</div>
	</div>
</template>
